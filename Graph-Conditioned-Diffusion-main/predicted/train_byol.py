...
from patient_dataset_byol import PatientDataset
import os
import pandas as pd
...
def parse_args():
    ...
    parser.add_argument('--unet1_checkpoint', type=str, default='checkpoints_byol/unet1_checkpoint.pt', help='Path to checkpoint for unet1 model')
    parser.add_argument('--unet2_checkpoint', type=str, default='checkpoints_byol/unet2_checkpoint.pt', help='Path to checkpoint for unet2 model')
    parser.add_argument('--unet3_checkpoint', type=str, default='checkpoints_byol/unet3_checkpoint.pt', help='Path to checkpoint for unet3 model')  
