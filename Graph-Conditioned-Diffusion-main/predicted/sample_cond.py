...
from train_byol import unet_generator, init_imagen
...
def find_graph_and_image_npy_files(directory):
    ...
    for root, dirs, files in os.walk(directory):
        ...
        for file in files:
            ...
            elif file == 'conditioning_extracted_1024.npy':
...
def parse_args():
    ...
    parser.add_argument('--unet1_checkpoint', type=str, default='checkpoints_byol/unet1_checkpoint_50000.pt', help='Path to checkpoint for unet1 model')
    parser.add_argument('--unet2_checkpoint', type=str, default='checkpoints_byol/unet2_checkpoint_50000.pt', help='Path to checkpoint for unet2 model')
    parser.add_argument('--unet3_checkpoint', type=str, default='checkpoints_byol/unet3_checkpoint_50000.pt', help='Path to checkpoint for unet3 model')
